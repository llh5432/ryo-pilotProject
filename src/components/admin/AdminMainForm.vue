<template>
  <b-container class="col-sm-9">
    <b-navbar toggleable="lg" type="dark" variant="dark">
      <b-navbar-nav>
        <b-navbar-brand to="/adminMain">Ryo-Pilot-Admin-Page</b-navbar-brand>
    ...
    <div class="col-sm-12 jumbotron-fluid">
      <b-card no-body type="null">
        <b-tabs card pills vertical>
          <b-tab active title="간단한 통계">
            <b-card-text>
              <AdminDashBoardForm></AdminDashBoardForm>
            </b-card-text>
          </b-tab>
          <b-tab title="메뉴 등록 | 수정">
            <b-card-text>
              <AdminMenuCUForm></AdminMenuCUForm>
            </b-card-text>
          </b-tab>
          <b-tab title="전체회원 내역">
            <b-card-text>
              <AdminUserListForm></AdminUserListForm>
            </b-card-text>
          </b-tab>
          <b-tab title="전체주문 내역">
            <b-card-text>
